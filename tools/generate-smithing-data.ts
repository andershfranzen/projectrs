...
const TIERS: Tier[] = [
  ...
  { name: "Black Bronze", miningLevel: 55, miningXp: 80,  smeltLevel: 50, smeltXp: 30, smithXpPerBar: 50, smithBaseLevel: 50, equipLevel: 25, statMultiplier: 3.0, barValue: 120, respawnTime: 120, depletionChance: 0.25, rockColor: [ 50, 100, 60]  },
  { name: "Mithril",    miningLevel: 70, miningXp: 95,  smeltLevel: 70, smeltXp: 38, smithXpPerBar: 63, smithBaseLevel: 70, equipLevel: 35, statMultiplier: 4.0, barValue: 240, respawnTime: 240, depletionChance: 0.20, rockColor: [ 70, 70, 120]  },
];
...
// But we need Silver, Gold, Black Bronze, and Mithril rocks
